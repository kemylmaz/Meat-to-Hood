...
PALETTE = {
    ...
    "MAT_TableCream":      ("F0DFA8", 0.78, 0.0),
    "MAT_BinTeal":         ("7FA9A5", 0.78, 0.0),
    "MAT_SoilDark":        ("4A3428", 0.86, 0.0),
    "MAT_LeafGreen":       ("6E9E68", 0.80, 0.0),
    "MAT_WallCap":         ("5A4032", 0.80, 0.0),
    "MAT_TileTerracotta":  ("C87B5C", 0.80, 0.0),
    "MAT_PlotUnderside":   ("C89A72", 0.84, 0.0),
    "MAT_DoorGlassTeal":   ("8FB8B4", 0.35, 0.0),
    "MAT_LockPlate":       ("9AA0AE", 0.55, 0.0),
    "MAT_MoneyGreen":      ("7BB369", 0.78, 0.0),
    "MAT_PadMint":         ("9FD0B4", 0.78, 0.0),
    "MAT_PadGold":         ("E8C463", 0.72, 0.0),
