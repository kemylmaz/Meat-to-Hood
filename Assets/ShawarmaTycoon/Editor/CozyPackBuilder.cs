...
namespace ShawarmaTycoon.EditorTools
{
    ...
    public static class CozyPackBuilder
    {
        ...
        private static readonly AssetSpec[] Specs =
        {
            ...
            // --- phase 3 soft cozy set ---
            new("50_customer_vest_green", "50_customer_vest_green", AssetProfile.Character, true, 0f),
            new("51_customer_vest_navy", "51_customer_vest_navy", AssetProfile.Character, true, 0f),
            new("52_customer_sweater", "52_customer_sweater", AssetProfile.Character, true, 0f),
            ...
            new("66_manager_desk_pencils", "66_manager_desk_pencils", AssetProfile.Environment, false, 0f),
            new("67_manager_desk_plant", "67_manager_desk_plant", AssetProfile.Environment, false, 0f),
            new("70_dining_table", "70_dining_table", AssetProfile.Prop, false, 0f),
            new("71_dining_table_dirty", "71_dining_table_dirty", AssetProfile.Prop, false, 0f),
            new("72_trash_bin", "72_trash_bin", AssetProfile.Prop, false, 0f),
            new("73_planter", "73_planter", AssetProfile.Prop, false, 0f),
            new("74_wrap_tray_stack", "74_wrap_tray_stack", AssetProfile.Prop, false, 0f),
            new("75_meat_tray_stack", "75_meat_tray_stack", AssetProfile.Prop, false, 0f),
            new("76_wall_corner", "76_wall_corner", AssetProfile.Environment, false, 0f),
            new("77_wall_straight", "77_wall_straight", AssetProfile.Environment, false, 0f),
            new("78_floor_tiled", "78_floor_tiled", AssetProfile.Environment, false, 0f),
            new("79_floor_plot", "79_floor_plot", AssetProfile.Environment, false, 0f),
            new("80_entrance", "80_entrance", AssetProfile.Environment, false, 0f),
            new("81_lock_pad", "81_lock_pad", AssetProfile.Prop, false, 0f),
            new("82_money_pad", "82_money_pad", AssetProfile.Prop, false, 0f),
            new("83_upgrade_pad", "83_upgrade_pad", AssetProfile.Prop, false, 0f)
        };
        ...
        private static readonly PaletteEntry[] Palette =
        {
            ...
            // --- phase 3 soft cozy set ---
            new("MAT_SkinSoft", 0xF2CDA9),
            new("MAT_HairSoft", 0x5B4232),
            new("MAT_FaceInk", 0x3B2A21),
            new("MAT_ShirtIvory", 0xF2EDDF),
            new("MAT_ShirtSky", 0xAECDE2),
            new("MAT_VestOlive", 0x4C6B3E),
            new("MAT_VestNavy", 0x3F4B63),
            new("MAT_TieGold", 0xE0A93B),
            new("MAT_SweaterTeal", 0x5CAFA6),
            new("MAT_TrouserCharcoal", 0x5A554E),
            new("MAT_TrouserKhaki", 0xC6B08D),
            new("MAT_ShoeBrown", 0x6B4530),
            new("MAT_ShoeCharcoal", 0x2E2B28),
            new("MAT_UniformTeal", 0x4FA9A2),
            new("MAT_UniformRed", 0xC4453E),
            new("MAT_WoodPale", 0xE0B87E),
            new("MAT_WoodPaleDark", 0xC79A63),
            new("MAT_PanelCream", 0xF0E6D2),
            new("MAT_ScreenGrey", 0x6E7686),
            new("MAT_ScreenGlass", 0xD8DAE0, 0f, 0.55f),
            new("MAT_ChairRed", 0xC9584A),
            new("MAT_ChairBlue", 0x5B87C4),
            new("MAT_BookMint", 0x9CCFC0),
            new("MAT_Taupe", 0xA79C90),
            new("MAT_TaupeDark", 0x8B8175),
            new("MAT_BoardAmber", 0xD89A46),
            new("MAT_BeltDark", 0x5C5A57),
            new("MAT_CounterDark", 0x4E4A45),
            new("MAT_LettuceGreen", 0x6FB04A),
            new("MAT_TomatoRed", 0xD9453C),
            new("MAT_SauceCream", 0xF2EDE0),
            new("MAT_LavashPale", 0xE8D7A8),
            new("MAT_KnifeSteel", 0xC8CCD2, 1f, 0.62f),
            new("MAT_TableCream", 0xF0DFA8),
            new("MAT_BinTeal", 0x7FA9A5),
            new("MAT_SoilDark", 0x4A3428),
            new("MAT_LeafGreen", 0x6E9E68),
            new("MAT_WallCap", 0x5A4032),
            new("MAT_TileTerracotta", 0xC87B5C),
            new("MAT_PlotUnderside", 0xC89A72),
            new("MAT_DoorGlassTeal", 0x8FB8B4, 0f, 0.55f),
            new("MAT_LockPlate", 0x9AA0AE, 0f, 0.40f),
            new("MAT_MoneyGreen", 0x7BB369),
            new("MAT_PadMint", 0x9FD0B4),
            new("MAT_PadGold", 0xE8C463)
        };
